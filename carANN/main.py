...
if __name__ == '__main__':
    ...
    #launchANN("graphes/Mutations_1/fig_Date-1524329057.9431782_Indiv-10_Mut-0.01_NeurHidden-7_Selection-E_Capteur-60/tabMeilleurs_Date-1524329057.9431782_Indiv-10_Mut-0.01_NeurHidden-7_Selection-E_Capteur-60.txt")
    launchRandomANN()